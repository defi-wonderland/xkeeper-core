...
interface IKeep3rHelperParameters {
  ...
  /// @return _poolAddress Address of the pool
  /// @return _isKP3RToken0 True if calling the token0 method of the pool returns the KP3R token address
  function kp3rWethPool() external view returns (address _poolAddress, bool _isKP3RToken0);
